---
name: git-worktree
description: 管理 Git worktree，在项目平级目录下创建，支持智能默认、IDE 集成和内容迁移
...
**关键修复**: 在现有 worktree 内创建新 worktree 时，始终使用绝对路径以防止路径嵌套问题。
